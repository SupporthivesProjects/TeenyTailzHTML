...
<html lang="en">
  ...
  <section class="error404-section">
      <div class="error404-panel">
        <img class="error404-background" src="./img/background_404.png" alt="A storybook maze in a forest with a child and a dragon">
        <div class="error404-content">
          <img class="error404-panel-texture" src="./img/404.png" alt="">
        <h1 id="error404-title">Page not found</h1>
        <p>The page you are looking for doesn't exist. Please try again later.</p>
        <div class="error404-actions">
          <button class="error404-button-home" href="index.php">
          <div class="button-backtohome">
            <div class="newdiv">
                <div class="newdiv_div">
                    Back to the homepage
                </div>
            </div>
        </div>
        </button>
        <button class="error404-button-library" href="#library">
        <div class="button-library">
            <div class="new_lib">
                <div class="new_lib_lib">
                    Go to the library
                </div>
            </div>
        </div>
